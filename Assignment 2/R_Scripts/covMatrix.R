...
bcb_mc <- X9_BinanceCoin$MarketCap[1:852]
...
market_cap_comatrix <- data.frame(btc_mc, eth_mc, xrp_mc, bcc_mc, usdt_mc, ltc_mc, eos_mc, bcb_mc, xtz_mc, xlm_mc, trx_mc, neo_mc, dash_mc)
View(market_cap_comatrix)
mc_covmatrix = matrix(c(cor(market_cap_comatrix)), nrow=13, ncol=13)
...
bcb_vt <- X9_BinanceCoin$VolumeTraded[1:852]
...
volume_traded_comatrix <- data.frame(btc_vt, eth_vt, xrp_vt, bcc_vt, usdt_vt, ltc_vt, eos_vt, bcb_vt, xtz_vt, xlm_vt, trx_vt, neo_vt, dash_vt)
View(volume_traded_comatrix)
vt_covmatrix = matrix(c(cov(volume_traded_comatrix)), nrow=13, ncol=13)
vt_covmatrix
covmatrix


market_cap_cormatrix <- data.frame(btc_mc, eth_mc, xrp_mc, bcc_mc, usdt_mc, ltc_mc, eos_mc, bcb_mc, xtz_mc, xlm_mc, trx_mc, neo_mc, dash_mc)
mc_cormatrix = matrix(c(cor(volume_traded_comatrix)), nrow=13, ncol=13)
mc_cormatrix

market_cap_cormatrix <- data.frame(btc_vt, eth_vt, xrp_vt, bcc_vt, usdt_vt, ltc_vt, eos_vt, bcb_vt, xtz_vt, xlm_vt, trx_vt, neo_vt, dash_vt)
vt_cormatrix = matrix(c(cor(volume_traded_comatrix)), nrow=13, ncol=13)
vt_cormatrix